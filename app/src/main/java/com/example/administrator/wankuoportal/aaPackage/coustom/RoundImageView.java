...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
     ...
     * 上圆角模式
     */
    private static final int TOP_ROUND = 3;
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.RoundImageView_roundType) ? a.getInt(R.styleable.RoundImageView_roundType, MODE_NONE) : MODE_NONE;

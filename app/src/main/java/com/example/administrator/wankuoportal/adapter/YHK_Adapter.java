...
public class YHK_Adapter extends BaseAdapter implements View.OnClickListener {
    private Context context;
    private List<YHK.DatasBean> list;
    private Callback mCallback;

    public YHK_Adapter(Context context, List<YHK.DatasBean> list,Callback callback) {

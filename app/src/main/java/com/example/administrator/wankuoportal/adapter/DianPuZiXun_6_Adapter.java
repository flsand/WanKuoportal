...
public class DianPuZiXun_6_Adapter extends BaseAdapter {
    private Context context;
    private List<ShopInformation.DatasBean> list;


    public DianPuZiXun_6_Adapter(Context context, List<ShopInformation.DatasBean> list) {

...
public class ReleaseSellGoldDialog extends Dialog {
    ...
    public ReleaseSellGoldDialog(@NonNull Context context, int themeResId) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_release_sell_gold, null);
        setContentView(view);

...
public class MyHttpInterceptor implements Interceptor {
    ...
    private boolean isJumpAcivity = false;

    public MyHttpInterceptor(String tag, boolean showResponse) {
...
//                                if (jsonObject.has("code") && "2".equals(jsonObject.getString("code"))) {
//
//                                    if (!isJumpAcivity){
//                                        MyApplication.getInstance().jumpLogin();
//                                    }
//                                }
//                            } catch (Exception e) {
//                                e.printStackTrace();

...
public class HelpcontentAdapter extends BaseAdapter {
    ...
    private Gethelpcontent gethelpcenter;


    public HelpcontentAdapter(Gethelpcontent getHelpcenter, Context mContext) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tx.setText(gethelpcenter.getDatas().get(i).getHelpQuestion());

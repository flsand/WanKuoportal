 ...
 * @since 2015/12/15
 */
public class AddressPickTask_buxian extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    public AddressPickTask_buxian(Activity activity) {
    ...
    protected ArrayList<Province> doInBackground(String... params) {
        ...
        try {
            String json = ConvertUtils.toString(activity.getAssets().open("city_buxian.json"));

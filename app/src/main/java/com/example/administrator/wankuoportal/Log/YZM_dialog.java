...
public class YZM_dialog extends Dialog {
    ...
    private android.widget.TextView txphone;
    private android.widget.EditText edyzm;
    private android.widget.TextView ok;
    private android.widget.TextView cancle;
    ...
    public YZM_dialog(@NonNull Context context, String title) {
        super(context);
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.yzm_dialog, null);

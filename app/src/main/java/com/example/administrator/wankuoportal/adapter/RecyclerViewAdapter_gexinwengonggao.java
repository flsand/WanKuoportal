 ...
 */
public class RecyclerViewAdapter_gexinwengonggao extends RecyclerView.Adapter<RecyclerViewAdapter_gexinwengonggao.ViewHolder> implements View.OnClickListener {

    private Context mContext;
    private List<GetGuiZe.DatasBean> dataList = new ArrayList<>();
    private RecyclerViewAdapter_shop.OnItemClickListener mOnItemClickListener = null;


    public void addAllData(List<GetGuiZe.DatasBean> dataList) {
    ...
    public RecyclerViewAdapter_gexinwengonggao(Context context) {
        mContext = context;
    }

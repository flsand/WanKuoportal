...
public class Store5_yiji_Adapter extends BaseAdapter {
    private Context context;
    private List<ShopExample.DataBean.LabellistBean> list;
    ...
    public Store5_yiji_Adapter(Context context, List<ShopExample.DataBean.LabellistBean> list) {

...
public class Store1_grid2Adapter extends BaseAdapter {


    private LayoutInflater mInflater;
    private Context mContext;
    private List<InitShop.DataBean.GoodExampleListBean> list;


    public Store1_grid2Adapter(Context mContext, List<InitShop.DataBean.GoodExampleListBean> list) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = mInflater.inflate(R.layout.store1_grid2, null);
        ...
        viewHolder.price.setText(list.get(i).getContent());

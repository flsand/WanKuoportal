...
/**
 * Created by lv
 * on 2017/9/26.  维权adapter
 */
public class RecyclerViewAdapter_weiquan extends RecyclerView.Adapter<RecyclerViewAdapter_weiquan.ViewHolder> {
    ...
    public RecyclerViewAdapter_weiquan(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.weiquan_adapter, parent, false);

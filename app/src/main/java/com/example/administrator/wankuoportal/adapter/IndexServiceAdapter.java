...
public class IndexServiceAdapter extends BaseAdapter {

    private List<GetIndexserve.DatasBean> dataList = new ArrayList<>();
    private LayoutInflater mInflater;
    private Context mContext;
    LinearLayout.LayoutParams params;


    public IndexServiceAdapter(List<GetIndexserve.DatasBean> mNameList, Context mContext) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        viewHolder.txName.setText(dataList.get(position).getAshopData().getShopName()+"/"+dataList.get(position).getAshopData().getProvince()+dataList.get(position).getAshopData().getCity());

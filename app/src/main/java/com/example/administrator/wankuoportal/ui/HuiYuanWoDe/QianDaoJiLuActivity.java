...
import com.example.administrator.wankuoportal.adapter.RecyclerViewAdapter_qiandao;
...
public class QianDaoJiLuActivity extends BaseActivity implements PullLoadMoreRecyclerView.PullLoadMoreListener {

    private android.widget.ImageView back;
    private android.widget.TextView title;
    private RecyclerView mRecyclerView;
    private com.wuxiaolong.pullloadmorerecyclerview.PullLoadMoreRecyclerView mPullLoadMoreRecyclerView;
    private RecyclerViewAdapter_qiandao mRecyclerViewAdapter;
    private int mCount = 1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qian_dao_ji_lu);
    ...
    private void initview() {
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter_qiandao(getBaseContext());
    ...
    public void getData() {
        ...
        String url = Apis.Base + Apis.getmysignin + "?token=" + accountId + "," + time + "," + token;
        OkHttpUtils
                .get()
                .url(url)
                ...
                .execute(new MyStringCallback() {
                    ...
                    public void onHttpResponse(String response, int id) throws Exception {
                        L.d(response);
                        QianDaoJiLu m = gson.fromJson(response, QianDaoJiLu.class);
                        if (m.getCode() == 0) {
                            ...
                            showShort(m.getMsg());
                            new UserService(QianDaoJiLuActivity.this).setislogin("1");
                        }

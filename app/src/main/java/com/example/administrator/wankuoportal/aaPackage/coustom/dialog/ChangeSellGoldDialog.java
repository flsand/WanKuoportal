...
public class ChangeSellGoldDialog extends Dialog {
    ...
    public ChangeSellGoldDialog(@NonNull Context context, int themeResId) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_change_sell_gold, null);
        setContentView(view);

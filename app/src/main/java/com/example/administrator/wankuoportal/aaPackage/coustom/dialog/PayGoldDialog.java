...
public class PayGoldDialog extends Dialog {
    ...
    public PayGoldDialog(@NonNull Context context, int themeResId) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_pay_gold, null);
        setContentView(view);

...
import com.example.administrator.wankuoportal.adapter.RecyclerViewAdapter_gexinwengonggao;
import com.example.administrator.wankuoportal.adapter.RecyclerViewAdapter_shop;
import com.example.administrator.wankuoportal.beans.GetGuiZe;
...
public class GZ_fragment extends BaseFragment implements PullLoadMoreRecyclerView.PullLoadMoreListener{
    ...
    RecyclerViewAdapter_gexinwengonggao mRecyclerViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter_gexinwengonggao(getActivity());
        ...
        OkHttpUtils
                ...
                .execute(new MyStringCallback() {
                    ...
                    public void onHttpResponse(String response, int id) throws Exception {
                        L.d(response);
                        GetGuiZe s = gson.fromJson(response,GetGuiZe.class);
                        if (s.getCode()==0){
    ...
    List<GetGuiZe.DatasBean> list  = new ArrayList<>();

...
public class WaveView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //渐变背景
        Shader mShader = new LinearGradient(getLeft(), getTop(), getRight(),getBottom(),
                new int[]{Color.parseColor("#FF8300"), Color.parseColor("#FF4C00")},
                new float[]{0.1f, 0.9f}, Shader.TileMode.REPEAT);
        Utils.print("left -= "+ getLeft());
        Utils.print("left -= "+ getRight());
        Utils.print("left -= "+ getBottom());
        //背景

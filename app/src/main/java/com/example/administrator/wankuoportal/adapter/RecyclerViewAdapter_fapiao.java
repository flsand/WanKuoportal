 ...
 */
public class RecyclerViewAdapter_fapiao extends RecyclerView.Adapter<RecyclerViewAdapter_fapiao.ViewHolder> {
    ...
    public RecyclerViewAdapter_fapiao(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.fapiao_adapter, parent, false);

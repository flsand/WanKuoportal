...
public class SellGoldDialog extends Dialog {
    ...
    public SellGoldDialog(@NonNull Context context, int themeResId) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_sell_gold, null);
        setContentView(view);
